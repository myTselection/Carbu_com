...
def create_schema(entry, option=False):
    ...
    if option and entry :
        ...
        default_super95 = entry.get(FuelType.SUPER95.name_lowercase, True)
        default_super95_e5 = entry.get(FuelType.SUPER95_E5.name_lowercase, True)
        default_super98 = entry.get(FuelType.SUPER98.name_lowercase, True)
        default_diesel = entry.get(FuelType.DIESEL.name_lowercase, True)
        default_lpg = entry.get(FuelType.LPG.name_lowercase, False)
...
class ComponentOptionsHandler(config_entries.ConfigFlow):
    ...
    async def async_step_edit(self, user_input):
        ...
        if user_input is not None:
            ...
            user_input[FuelType.SUPER95.name_lowercase] = self.config_entry.data.get(FuelType.SUPER95.name_lowercase, True)
            user_input[FuelType.SUPER95_E5.name_lowercase] = self.config_entry.data.get(FuelType.SUPER95_E5.name_lowercase, True)
            user_input[FuelType.SUPER98.name_lowercase] = self.config_entry.data.get(FuelType.SUPER98.name_lowercase, True)
            user_input[FuelType.DIESEL.name_lowercase] = self.config_entry.data.get(FuelType.DIESEL.name_lowercase, True)
            user_input[FuelType.LPG.name_lowercase] = self.config_entry.data.get(FuelType.LPG.name_lowercase, False)
